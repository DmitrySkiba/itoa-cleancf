...
#undef CF_VALIDATE_ALLOCATOR_ARG
#define CF_VALIDATE_ALLOCATOR_ARG(allocator) \
	CF_VALIDATE_OBJECT_ARG(CF, allocator, __kCFAllocatorTypeID)
...
CFAllocatorRef CFAllocatorGetDefault(void) {
    CFAllocatorRef allocator = _CFGetThreadSpecificData()->_allocator;
    if (!allocator) {
...
void CFAllocatorSetDefault(CFAllocatorRef allocator) {
    CFAllocatorRef current = (CFAllocatorRef)_CFGetThreadSpecificData()->_allocator;
    ...
    if (allocator != current) {
        ...
        CFRetain(allocator);
        _CFGetThreadSpecificData()->_allocator = allocator;
    }
}
