...
//TODO format CFLocale_Identifier
        ...
        if ( isalpha(*inLocalePtr) ) {
            ...
            *inLocalePtr = (!hadRegion)? tolower(*inLocalePtr): toupper(*inLocalePtr);
            ...
            if (!pastPrimarySubtag) {
                ...
                size_t subtagLength = inLocalePtr - subtagPtr; // includes leading '-' or '_'
...
CF_INTERNAL CFStringRef _CFLocaleCreateCanonicalLanguageIdentifierForCFBundle(CFAllocatorRef allocator, CFStringRef localeIdentifier) {
