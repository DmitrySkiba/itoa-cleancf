...
#if !defined(__COREFOUNDATION_CFSORTFUNCTIONS__)
#define __COREFOUNDATION_CFSORTFUNCTIONS__ 1

#include <CoreFoundation/CFBase.h>

// TODO add description for CFMergeSortArray
