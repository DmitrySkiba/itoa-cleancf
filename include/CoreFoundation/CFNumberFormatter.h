...
CF_EXPORT
CFStringRef CFNumberFormatterCreateStringWithNumber(CFAllocatorRef allocator,
 ...
 */
CF_EXPORT
CFStringRef CFNumberFormatterCreateStringWithValue(CFAllocatorRef allocator,
												   CFNumberFormatterRef formatter,
...
CF_EXPORT
CFNumberRef CFNumberFormatterCreateNumberFromString(CFAllocatorRef allocator,
													CFNumberFormatterRef formatter,
													CFStringRef string,
													CFRange *rangep,
 ...
 */
CF_EXPORT
Boolean CFNumberFormatterGetValueFromString(CFNumberFormatterRef formatter,
											CFStringRef string,
											CFRange *rangep,
											CFNumberType numberType,
											void *valuePtr);
...
CF_EXPORT const CFStringRef kCFNumberFormatterCurrencyGroupingSeparator; // CFString
CF_EXPORT const CFStringRef kCFNumberFormatterIsLenient; // CFBoolean
CF_EXPORT const CFStringRef kCFNumberFormatterUseSignificantDigits; // CFBoolean
CF_EXPORT const CFStringRef kCFNumberFormatterMinSignificantDigits; // CFNumber
CF_EXPORT const CFStringRef kCFNumberFormatterMaxSignificantDigits; // CFNumber
 ...
 */
CF_EXPORT
Boolean CFNumberFormatterGetDecimalInfoForCurrencyCode(CFStringRef currencyCode,
